...
@register_metric
def fid50k_full_denoising(opts):
    opts.dataset_kwargs.update(max_size=None, xflip=False)
    d = {}

    for t_max in opts.dfid_ts:
        fid = frechet_inception_distance.compute_fid(opts, max_real=None, num_gen=50000, t_max=t_max)
        d[f'fid50k_full_denoising_{t_max:.3g}'] = fid
    return d
