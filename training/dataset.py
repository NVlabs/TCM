...
#
# This file has been taken from ECT codebase, which built upon EDM.
#
# Source:
# https://github.com/NVlabs/edm/blob/main/training/dataset.py (EDM)
# https://github.com/locuslab/ect/blob/main/training/dataset.py (ECT)
#
